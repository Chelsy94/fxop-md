...
SESSION_ID: (process.env.SESSION_ID || "Session~hRpqTcjM").trim(),
...
GOODBYE_MSG: process.env.GOODBYE_MSG || "ce fut un plaisir d'échanger avec toi signer LE DALTON",
ANTILINK: process.env.ANTILINK || true,
AUTO_BIO: process.env.AUTO_BIO || true,
AUTO_REACT: process.env.AUTO_REACT || false,
AUTO_READ: toBool(process.env.AUTO_READ) || false,
AUTO_STATUS_READ: toBool(process.env.AUTO_STATUS_READ) || true,
STICKER_PACK: process.env.AUTHOR || "Astro; Laurian",
